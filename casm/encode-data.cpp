	...
	opcodePrefix(PREFIX_BYTE::NONE)
{
	...
	operandPlace[0] = OperandPlace::unused;
	operandPlace[1] = OperandPlace::unused;
	operandPlace[2] = OperandPlace::unused;
	operandPlace[3] = OperandPlace::unused;
	operandPlace[4] = OperandPlace::unused;
}
