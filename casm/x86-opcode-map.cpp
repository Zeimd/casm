...
#include "x86-opcodes-sse.h"
#include "x86-opcodes-sse2.h"
#include "x86-opcodes-sse3.h"
#include "x86-opcodes-sse41.h"
#include "x86-opcodes-avx.h"
#include "x86-opcodes-avx2.h"
...
std::shared_ptr<OpcodeMap> OpcodeMap::GetInstance()
{
	if (instance == nullptr)
	{
		instance = std::shared_ptr<OpcodeMap>(new OpcodeMap());
